...
<div class="accessories index large-9 medium-8 columns content">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                <td><?= $this->Html->link(h($accessory->title), ['action' => 'view', $accessory->id]) ?></td>
                ...
                <td class="actions">
                    ...
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $accessory->id], ['confirm' => __('Are you sure you want to delete {0}?', $accessory->title)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
